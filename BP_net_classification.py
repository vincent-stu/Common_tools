...
# MLPClassifier;
clf = MLPClassifier(hidden_layer_sizes=(100,50,4), max_iter=500)

# 拟合模型
clf.fit(Xtrain, Ytrain.ravel())

# 预测
some_digit_predict = clf.predict(Xtest)
# 模型精度
...
plt.savefig(r'G:\landsat8_fei\分类结果的混淆矩阵_BP4.jpg', dpi = 300)


# 对测试集进行分类
predict1 = clf.predict(rarray0)
predict1  = predict1.reshape(2951,3386)        # 行数 * 列数
# 输出tiff图像
driver = gdal.GetDriverByName("GTiff")
dataset = driver.Create(r"G:\landsat8_fei\classification_result\result_bp4.tif",3386,2951,1,gdal.GDT_Float32)
