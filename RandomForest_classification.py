...
plt.savefig(r'G:\landsat8_fei\分类结果的混淆矩阵_RF4.jpg', dpi = 300)
...
dataset = driver.Create(r"G:\landsat8_fei\classification_result\result_rf4.tif",3386,2951,1,gdal.GDT_Float32)
